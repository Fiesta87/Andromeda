...
namespace Carbon
{
	...
	Transform::Transform(const Transform& other)
		...
		, m_bfDirty(other.m_bfDirty)
		, m_pEntity(other.m_pEntity)
		, m_pParent(other.m_pParent)
	{
		if (!m_bfDirty)
		{
			m_worldTransformMatrixCache = other.m_worldTransformMatrixCache;
			m_worldRotationCache = other.m_worldRotationCache;
			m_rightCache = other.m_rightCache;
			m_upCache = other.m_upCache;
			m_forwardCache = other.m_forwardCache;
		}
	}
