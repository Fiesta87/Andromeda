...
namespace Carbon
{
	...
	{
		return
			fabs(m00 - other.m00) < Carbon::epsilon && fabs(m01 - other.m01) < Carbon::epsilon && fabs(m02 - other.m02) < Carbon::epsilon && fabs(m03 - other.m03) < Carbon::epsilon &&
			fabs(m10 - other.m10) < Carbon::epsilon && fabs(m11 - other.m11) < Carbon::epsilon && fabs(m12 - other.m12) < Carbon::epsilon && fabs(m13 - other.m13) < Carbon::epsilon &&
			fabs(m20 - other.m20) < Carbon::epsilon && fabs(m21 - other.m21) < Carbon::epsilon && fabs(m22 - other.m22) < Carbon::epsilon && fabs(m23 - other.m23) < Carbon::epsilon;
	}
